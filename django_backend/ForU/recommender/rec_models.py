...
class Recommender:
    ...
    def singer_recommend(self, user, rec_songs_cnt = 30, rate_of_familiar_songs = 0.2, artist_sample = 5):
        ...
        #유저 아티스트 랜덤 샘플 가져오기
        if artist_sample and len(list(*user['artists'].values)) > artist_sample: 
